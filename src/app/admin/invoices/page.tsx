...
import { Save, FileText, Eye, Settings2, Upload } from "lucide-react";
...
export default function InvoicesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="الفواتير" subtitle="تخصيص شكل الفاتورة والمعلومات" actions={
        <div className="flex gap-2">
          <Button variant="secondary" icon={<Eye size={16} />} onClick={() => setShowPreview(!showPreview)}>{showPreview ? "إخفاء المعاينة" : "معاينة"}</Button>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }}>
          <Card>
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="font-semibold text-text">معلومات الشركة</h3>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.15 }}>
          <Card>
            <div className="flex items-center gap-3 mb-5">
              ...
              <h3 className="font-semibold text-text">إعدادات الفاتورة</h3>
            </div>
            <div className="space-y-4">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.2 }} className="xl:col-span-2">
          <Card>
            <div className="flex items-center gap-3 mb-5">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary-light">
                <FileText size={16} className="text-primary" />
              </div>
              <h3 className="font-semibold text-text">الملاحظات والشروط</h3>
            </div>
