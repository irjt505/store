...
import { Save, Upload, Image, ExternalLink, Wrench } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card header={<h3 className="font-semibold text-text">معلومات المتجر</h3>} padding="md">
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div><Button variant="secondary" size="sm" icon={<Upload size={14} />} onClick={() => logoInputRef.current?.click()}>رفع شعار</Button><p className="mt-1.5 text-xs text-text-muted">PNG أو SVG، الحد الأقصى 2 ميجا</p></div>
              </div>
            </div>
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-lg border-2 border-dashed border-border bg-surface-hover overflow-hidden">
        ...
        <Card header={<h3 className="font-semibold text-text">معلومات الاتصال</h3>} padding="md">
          <div className="space-y-4">
        ...
        <Card header={<h3 className="font-semibold text-text">المنطقة والإعدادات Locale</h3>} padding="md">
          <div className="space-y-4">
        ...
        <Card header={<h3 className="font-semibold text-text">العملة</h3>} padding="md">
          <div className="space-y-4">
        ...
        <Card header={<h3 className="font-semibold text-text flex items-center gap-2"><Wrench size={18} className="text-warning" /> وضع الصيانة</h3>} padding="md" className="xl:col-span-2">
          <div className="space-y-4">
        ...
        <Card header={<h3 className="font-semibold text-text">وسائل التواصل الاجتماعي</h3>} padding="md" className="xl:col-span-2">
