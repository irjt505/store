...
import { Save, AlertTriangle, ShoppingCart, Package, ClipboardList, CreditCard } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card header={<div className="flex items-center gap-2"><ShoppingCart size={18} className="text-primary" /><h3 className="font-semibold text-text">حالة المتجر</h3></div>} padding="md">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div><p className="text-sm font-medium text-text">حالة المتجر</p><p className="text-xs text-text-muted">تحديد ما إذا كان المتجر متاحاً للزوار</p></div>
            ...
            {storeStatus === "maintenance" && (
              <div className="rounded-lg border border-warning/30 bg-warning/5 p-4">
                <div className="flex items-center gap-2 mb-2"><AlertTriangle size={16} className="text-warning" /><p className="text-sm font-medium text-warning">وضع الصيانة مفعّل</p></div>
        ...
        <Card header={<div className="flex items-center gap-2"><ShoppingCart size={18} className="text-primary" /><h3 className="font-semibold text-text">إعدادات السلة</h3></div>} padding="md">
        ...
        <Card header={<div className="flex items-center gap-2"><Package size={18} className="text-primary" /><h3 className="font-semibold text-text">إعدادات المنتجات</h3></div>} padding="md">
          <div className="space-y-5">
        ...
        <Card header={<div className="flex items-center gap-2"><ClipboardList size={18} className="text-primary" /><h3 className="font-semibold text-text">إعدادات الطلبات</h3></div>} padding="md">
          <div className="space-y-5">
        ...
        <Card header={<div className="flex items-center gap-2"><CreditCard size={18} className="text-primary" /><h3 className="font-semibold text-text">إعدادات الدفع والشحن</h3></div>} padding="md">
          <div className="space-y-5">
        ...
        <Card header={<h3 className="font-semibold text-text">إعدادات الإشعارات</h3>} padding="md">
          <div className="space-y-5">
