...
import { Save, Upload, RefreshCw, ExternalLink, Search, Link2 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ delay: 0.05 }}>
          <Card header={<SectionLabel icon={Search} label="البيانات الوصفية" />} padding="md">
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex h-24 w-40 items-center justify-center rounded-xl border-2 border-dashed border-border bg-surface-hover overflow-hidden transition-colors hover:border-primary/40">
                  ...
                  <div>
                    <Button variant="secondary" size="sm" icon={<Upload size={14} />} onClick={() => ogImageInputRef.current?.click()}>رفع صورة</Button>
                    <p className="mt-1.5 text-xs text-text-muted">1200×630 بكسل، PNG أو JPG</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ delay: 0.1 }}>
          <Card header={<SectionLabel icon={Link2} label="خريطة الموقع" />} padding="md">
            <div className="space-y-5">
              ...
              <div className="rounded-xl bg-surface-hover p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-text">آخر تحديث</p>
                    <p className="text-xs text-text-muted">18 يوليو 2026 - 10:30 ص</p>
                  </div>
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ delay: 0.15 }} className="xl:col-span-2">
          <Card header={<SectionLabel icon={Search} label="الفهرسة و robots.txt" />} padding="md">
      ...
      <motion.div initial="hidden" animate="visible" variants={fadeUp} transition={{ delay: 0.2 }} className="flex justify-end sticky bottom-4 z-10">
